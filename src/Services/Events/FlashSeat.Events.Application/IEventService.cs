...
public interface IEventService
{
    ...
    Task<EventMetadataResponse?> GetMetadataAsync(Guid eventId, CancellationToken cancellationToken);
    ...
    Task<bool> UnpublishAsync(Guid eventId, CancellationToken cancellationToken);
    Task<bool> RestoreDraftAsync(Guid eventId, CancellationToken cancellationToken);
    Task<bool> RepublishAsync(Guid eventId, CancellationToken cancellationToken);
    Task<bool> ArchiveAsync(Guid eventId, CancellationToken cancellationToken);
}
